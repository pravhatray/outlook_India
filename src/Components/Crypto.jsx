...
const Crypto = () => {
    ...
    const handleCrypto = () => {
        ...
        axios.get(`https://outlook-india-news.herokuapp.com/bitcoins`).then((res) => {
    ...
    const handleCryptoMore = () => {
        dispatch({ type: "LOADING_DATA" })
        axios.get(`https://outlook-india-news.herokuapp.com/bitcoin_details?_sort=id&_order=DESC`).then((res) => {

            dispatch({ type: "CRYPTO_MORE_DATA", payload: res.data })
        }).catch((err) => {
            console.log("err", err)
        })
    }
