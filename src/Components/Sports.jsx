...
const Sports = () => {
    ...
    const handleSports = () => {
        ...
        axios.get(`https://outlook-india-news.herokuapp.com/sports`).then((res) => {
    ...
    const handleSportsMore = () => {
        dispatch({ type: "LOADING_DATA" })
        axios.get(`https://outlook-india-news.herokuapp.com/sports_details?_sort=id&_order=DESC`).then((res) => {

            dispatch({ type: "SPORTS_MORE_DATA", payload: res.data })
        }).catch((err) => {
            console.log("err", err)
        })
    }
